...
var _sutroClient = _interopRequireDefault(require("sutro-client"));
...
const createClient = (_ref = {}) => {
  ...
  const opts = _objectSpread(_objectSpread({}, rest), {}, {
    root,
  ...
  return (0, _sutroClient.default)(_meta.default, opts);
};
